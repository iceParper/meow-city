  ...
  <div class="app-container">
    ...
    >
      <div style="display:flex;">
        ...
        <el-form-item label="通过/拒绝" style="margin-left:80px;" prop="status">
          <el-switch
      ...
      <div v-if="dialogForm.status == 1">
        ...
        <el-form-item label="审批意见" prop="agreeOpinions" style="width:100%;">
          <el-input
            v-model="dialogForm.agreeOpinions"
            type="textarea"
            :rows="3"
            placeholder="审批意见"
          />
        </el-form-item>
        <el-form-item label="审批额度" prop="quota" style="width:100%;">
          <el-input v-model="dialogForm.quota" placeholder="审批额度" />
        </el-form-item>
      </div>
      <div v-else>
        <el-form-item label="拒绝意见" prop="noAgreeOpinions" style="width:100%;">
          <el-input
            v-model="dialogForm.noAgreeOpinions"
            type="textarea"
            :rows="3"
            placeholder="拒绝意见"
          />
