      ...
      >
        <template slot-scope="{ row }">
          <el-button
            ...
            style="padding: 7px 0"
            v-if="handleBtnShow[3].isShow && row.status == 3"
            >重新申请</el-button
          >
        </template>
      </el-table-column>
...
import { applyBorrowMoneyList } from "@/api/borrowMoneyManage";
...
export default {
  ...
  data() {
    return {
      ...
      handleBtnShow: [
        {
          btnName: "LoanLoanApplyQuery",
          isShow: false,
        },
        {
          btnName: "LoanLoanApply",
          isShow: false,
        },
        {
          btnName: "LoanLoanApplyDetail",
          isShow: false,
        },
        {
          btnName: "LoanLoanApplyModify",
          isShow: false,
        },
      ],
      handleBtnFuncArr: [],
  ...
  methods: {
    async getList() {
      ...
      let res = await applyBorrowMoneyList({
        ...this.listQuery,
      });
      console.log(res, "res");
      if (res.rtn == 1) {
