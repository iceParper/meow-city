      ...
      >
        <template slot-scope="{ row }">
          ...
          <el-button
            ...
            @click="explain(row)"
            v-if="
              handleBtnShow[3].isShow && (row.status == 0 || row.status == 4)
            "
            >异常说明</el-button
          >
        </template>
...
export default {
  ...
  data() {
    return {
      ...
      handleBtnShow: [
        {
          btnName: "RiskInspectionQuery",
          isShow: false,
        },
        {
          btnName: "RiskInspectionDetail",
          isShow: false,
        },
        {
          btnName: "RiskInspectionReject",
          isShow: false,
        },
        {
  ...
  methods: {
    async getList() {
      ...
      let res = await inspectionRecord({
        ...this.listQuery,
      });
      console.log(res);
      if (res.rtn == 1) {
    ...
    toDtl(row) {
      ...
      this.$router.push({
        ...
        query: {
          ...
          beforeRouter: "InspectRecordManage",
        },
      });
    },
    handleReject(row) {
