<template>
  <div class="app-container">
        ...
        <div class="section">
          <div class="companyDtl">
            <div class="companyDtl__inner">
              ...
              <div class="companyDtl__line__item">
                <div class="companyDtl__line__lab">累计积分：</div>
                <div class="companyDtl__line__txt">{{companyDtl.contactPhone}}</div>
              </div>
              <div class="companyDtl__line__item">
                <div class="companyDtl__line__lab">积分余额：</div>
                <div
                  class="companyDtl__line__txt col_red fontWei_700"
                >{{companyDtl.province}}{{companyDtl.city}}{{companyDtl.county}}{{companyDtl.detailAddress}}</div>
              </div>
    ...
    >
      ...
      <el-form-item label="调整金额" prop="quota">
        <el-input v-model="dialogForm.quota" placeholder="调整金额" style="width:40%;margin-right:30px;" />
      ...
      <el-form-item label="审批意见" prop="agreeOpinions" style="width:100%;">
        <el-input v-model="dialogForm.agreeOpinions" type="textarea" :rows="3" placeholder="审批意见" />
      </el-form-item>
    </el-form>
